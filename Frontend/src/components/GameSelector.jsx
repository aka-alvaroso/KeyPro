  ...
  function handleClick (btn) {
    ...
    switch (btn) {
      ...
      case 'words':
        ...
        setType('words')
        setShowSettings(false)
        gameSettings.type = 'normal'
        break
      case 'code':
        setSelector('code')
        setType('code')
        setShowSettings(true)
        gameSettings.type = 'code'
        break
      case 'phrases':
        setSelector('phrases')
        setType('phrases')
  ...
  function handleClickMenu (btn) {
    ...
    switch (btn) {
      ...
      case 'python':
        ...
        setShowSettings(false)
        gameSettings.language = 'python'
        break
      case 'javascript':
        setCodeSettings('javascript')
        setShowSettings(false)
        gameSettings.language = 'javascript'
        break
      case 'c++':
        setCodeSettings('c++')
        setShowSettings(false)
        gameSettings.language = 'c++'
        break
      case 'html':
        setCodeSettings('html')
        setShowSettings(false)
        gameSettings.language = 'html'
        break
      case 'java':
        setCodeSettings('java')
        setShowSettings(false)
        gameSettings.language = 'java'
        break
    }
  }
